...
import 'package:simplifi/features/recharge_airtme/airtime_auth_pin/input_airtime_pin_cntroller.dart';
import 'package:simplifi/routes/exports.dart';

class InputAirtimePinView extends StatelessWidget {
  const InputAirtimePinView({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    return GetBuilder<InputAirtimePinController>(
      init: InputAirtimePinController(),
      builder: (controller) {
        return Scaffold(
            body: SafeArea(
          top: true,
